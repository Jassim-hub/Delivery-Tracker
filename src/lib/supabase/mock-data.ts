...
export const INITIAL_STATUS_HISTORY: DeliveryStatusHistory[] = [
  ...
  },
  {
    ...
    status: 'assigned',
    changed_by: 'a0000000-0000-0000-0000-000000000001',
    note: 'Dispatched to Yawe Ivan (Yamaha DT 125)',
...
export const INITIAL_CHAT_MESSAGES: ChatMessage[] = [
  {
    ...
    content: 'Hello David! I have picked up your order and I am en route now.',
    created_at: new Date(Date.now() - 15 * 60000).toISOString(),
  ...
  },
  {
    ...
    content: 'Thank you Ivan! Please notify security at Gate B when you arrive.',
  ...
  },
  {
    ...
    content: 'Ivan, please note road works near Jinja Rd roundabout. Use Lugogo bypass if congested.',
    created_at: new Date(Date.now() - 45 * 60000).toISOString(),
  ...
  },
  {
    ...
    thread_id: 'e0000000-0000-0000-0000-000000000002',
    sender_id: 'b0000000-0000-0000-0000-000000000001',
    content: 'Got it, taking the Kololo bypass now. Thanks Jassim.',
